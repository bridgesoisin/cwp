...
const PAGES = [
  ...
  { file: 'journal',    palette: 'lapis',       seed: 6100,
    headline: 'Everything we keep <em>being asked.</em>', sub: 'The Journal' },
  { file: 'journal-latin-mass', palette: 'chiaroscuro', seed: 2044,
    headline: 'Arranging a Traditional Latin <em>nuptial Mass.</em>',
    sub: 'The Journal &middot; Ireland' },
  { file: 'journal-paperwork',  palette: 'gesso',       seed: 4410,
    headline: 'The paperwork, <em>in the right order.</em>',
    sub: 'The Journal &middot; Ireland' },
